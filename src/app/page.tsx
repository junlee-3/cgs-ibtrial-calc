    ...
    <main className="mx-auto w-full max-w-4xl px-4 pb-24 pt-10 sm:px-6">
      <header className="text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-balance text-muted-foreground">
          For Canberra Grammar School students — grades are worked out from the CGS 2026 grade boundaries (3-year average) using your trial exam marks. Exam papers only; IAs are not counted.
        </p>
      </header>
      <Link
        href="/boundaries"
